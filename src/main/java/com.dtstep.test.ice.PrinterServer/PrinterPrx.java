...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        printStr(str, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void printStr(String str, java.util.Map<String, String> context)
    {
        _iceI_printStrAsync(str, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printStrAsync(String str)
    {
        return _iceI_printStrAsync(str, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printStrAsync(String str, java.util.Map<String, String> context)
    {
        return _iceI_printStrAsync(str, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printStrAsync(String iceP_str, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "printStr", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeString(iceP_str);
                 }, null);
        return f;
    }
